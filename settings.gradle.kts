...
include ("ee:ee-common_java", "ee:ee-common", "ee:ee-lang_item", "ee:ee-lang_gen", "ee:ee-lang",
    ...
    "ee:ee-design_task", "ee:tornadoFxBom")
//include "ee:ee-axon_example"
include ("ee-slides:ee-slides_des", "ee-slides:ee-slides", "ee-slides:ee-slides_json")
...
include ("ee-office:ee-excel", "ee-office:ee-powerpoint", "ee-office:ee-msaccess", "ee-office:ee-word", "ee-office:ee-translate", "ee-office:ee-docx4j")
include ("ee-email:ee-email", "ee-email:ee-email_des", "ee-email:ee-email_excel")
include ("ee-grab:ee-grab", "ee-grab:ee-fiveh", "ee-grab:ee-rulit", "ee-grab:ee-moodle", "ee-grab:ee-unisa", "ee-grab:ee-brill", "ee-grab:ee-sharepoint")
